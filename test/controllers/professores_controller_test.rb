...
class ProfessoresControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { academia_id: @professor.academia_id, cpf: @professor.cpf, endereco: @professor.endereco, nome: @professor.nome, telefone: @professor.telefone }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { academia_id: @professor.academia_id, cpf: @professor.cpf, endereco: @professor.endereco, nome: @professor.nome, telefone: @professor.telefone }
    assert_redirected_to professor_path(assigns(:professor))
  end
