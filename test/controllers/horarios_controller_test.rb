...
class HorariosControllerTest < ActionController::TestCase
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post :create, horario: { Academia_id: @horario.Academia_id, Professor_id: @horario.Professor_id, hora: @horario.hora }
    end
  ...
  test "should update horario" do
    patch :update, id: @horario, horario: { Academia_id: @horario.Academia_id, Professor_id: @horario.Professor_id, hora: @horario.hora }
    assert_redirected_to horario_path(assigns(:horario))
  end
